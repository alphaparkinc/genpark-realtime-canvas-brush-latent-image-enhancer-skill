# genpark-realtime-canvas-brush-latent-image-enhancer-skill
...
> **GenPark AI Agent Skill** -- Real-time brush canvas latent image synthesizer and neural upscaler (Krea style)
